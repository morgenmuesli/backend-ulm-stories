  ...
  [
    function(t, e, n) {
      ...
      (function(t, n) {
        ...
        var jt = Object.getOwnPropertyNames($t),
          It = !0;
        function Nt(t) {
          It = t;
        }
        ...
        var Po = function(t) {
          ...
          Mo = R({ tag: String, moveClass: String }, $o);
        function Do(t) {
          ...
          render: function(t) {
            ...
            if ("a" === this.tag) (data.on = k), (data.attrs = { href: d });
              ...
              if (a) {
                a.isStatic = !1;
                var $ = (a.data = c({}, a.data));
                for (var j in (($.on = $.on || {}), $.on)) {
                  var I = $.on[j];
                  j in k && ($.on[j] = Array.isArray(I) ? I : [I]);
                }
                for (var N in k) N in $.on ? $.on[N].push(k[N]) : ($.on[N] = E);
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, w, x, O, S) {
        ...
        var A,
          ...
          P = N || C(x),
          L = x ? ($ ? C("entries") : P) : void 0,
          R = ("Array" == e && I.entries) || N;
        if (
          (R &&
            (k = v(R.call(new t()))) !== Object.prototype &&
            k.next &&
            (h(k, T, !0), r || "function" == typeof k[y] || f(k, y, _)),
          $ &&
            N &&
            "values" !== N.name &&
            ((j = !0),
