  ...
  [
      ...
      (function(t, n) {
        ...
        function Kr(t, e) {
          ...
          if (
            ...
            for (f in m) (r = m[f]) !== v[f] && Hr(l, f, r == null ? "" : r);
          }
        }
                ...
                z &&
                  ...
                  io(function() {
                    so(n, P),
                      G.cancelled ||
                        (ao(n, L),
                        H || (mo(B) ? setTimeout(G, B) : co(n, f, G)));
                  })),
            ...
            k.cancelled ||
              ...
              A &&
                ...
                io(function() {
                  so(n, l),
                    k.cancelled ||
                      (ao(n, h), E || (mo(C) ? setTimeout(k, C) : co(n, f, k)));
                })),
              y && y(n, k),
              A || E || k());
          }
        ...
        (Tn.config.mustUseProp = function(t, e, n) {
          ...
          (e.a = Tn);
      }.call(this, n(60), n(203).setImmediate));
    },
    ,
    ,
    function(t, e, n) {
    ...
    function(t, e, n) {
      ...
      f(f.S + f.F * vt, "Object", {
        ...
        U.prototype[H] || n(43)(U.prototype, H, U.prototype.valueOf),
        m(U, "Symbol"),
        m(Math, "Math", !0),
        m(r.JSON, "JSON", !0);
    },
    ...
    function(t, e, n) {
      ...
      const A = function(t) {
        ...
        if (typeof e === "string" && e.length > 2) {
          ...
          let r;
          let o;
          const c = (e = S ? e.trim() : y(e, 3)).charCodeAt(0);
          if (c === 43 || c === 45) {
    ...
    function(t, e, n) {
      ...
      const r = n(17);
      const o = n(137);
      r(r.P + r.F * n(138)("includes"), "String", {
        includes(t) {
        ...
        return [
          ...
          function(t, e) {
            ...
            for (var C, k = "", $ = 0, i = 0; i < A.length; i++) {
              ...
              const P = E.groups;
              if (_) {
                const M = [j].concat(I, T, y);
                void 0 !== P && M.push(P);
                var L = String(e.apply(void 0, M));
              } else L = x(j, y, T, I, P, e);
          ...
          [
            ...
            function(t, e) {
              ...
              for (var p = 0, q = 0, C = []; q < y.length; ) {
                ...
                if (
                  $ === null ||
                  (k = m(l(A.lastIndex + (_ ? 0 : q)), y.length)) === p
                )
                  q = f(y, q, O);
                else {
    ...
    function(t, e, n) {
      ...
      const c = n(137);
      const f = "".startsWith;
      r(r.P + r.F * n(138)("startsWith"), "String", {
        startsWith(t) {
        ...
        return (
                ...
                function() {
                  ...
                  Ut() &&
                    t.transitionTo(Bt(), function(r) {
                      n && mt(t.router, r, e, !0), St || Ht(r.fullPath);
                    });
                }
              );
          }),
          (e.prototype.push = function(t, e, n) {
            ...
            this.transitionTo(
              t,
              function(t) {
                Vt(t.fullPath), mt(r.router, t, o, !1), e && e(t);
              },
              n
            );
          }),
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, w, x, O, S) {
        ...
        let T = !1;
        var I = t.prototype;
        const N = I[m] || I["@@iterator"] || (x && I[x]);
        let P = N || k(x);
        const M = x ? (j ? k("entries") : P) : void 0;
        const L = (e == "Array" && I.entries) || N;
        if (
          (L &&
            (C = v(L.call(new t()))) !== Object.prototype &&
            C.next &&
            (h(C, $, !0), r || typeof C[m] === "function" || f(C, m, _)),
          j &&
            N &&
            N.name !== "values" &&
            ((T = !0),
    ...
    function(t, e, n) {
      ...
      (function(t) {
        ...
        function G(object, t, e) {
          H(object, t), object[t].push(e);
        }
        function K(t) {
        ...
        function tt(t, e, n) {
          ...
          return (
            I.forEach(function(t, n) {
              if (n === 0) H(e, t);
              else if (n === 1) for (const o in e[t]) H(e[t], o);
              r[t] = e[t];
            }),
            (function t(e, n, r, o) {
              ...
              for (const m in e) {
                ...
                if (V(N, m)) v[m] = y;
                  ...
                  let _ = I[0];
                  if (r[_] && V(r[_], m)) v[m] = y;
                  else {
                    const w = e[c];
                    if (w && ((_ = I[1]), r[_] && r[_][w] && V(r[_][w], m)))
                      v[m] = y;
                    else if (
                      (typeof y === "string"
                        ? (v[m] = d(y))
    ...
    function(t, e, n) {
      ...
      const v = function(t, e, n) {
        ...
        const d = (o[t] = l ? e(m) : f[t]);
        n && (o[n] = d), r(r.P + r.F * l, "String", o);
      };
      var m = (v.trim = function(t, e) {
        return (
          (t = String(o(t))),
          1 & e && (t = t.replace(d, "")),
          2 & e && (t = t.replace(h, "")),
        ...
        "Array",
        {
          from(t) {
            ...
            if (
              ...
              for (n = new _((e = d(y.length))); e > S; S++)
                h(n, S, O ? x(y[S], S) : y[S]);
            else
              for (m = A.call(y), n = new _(); !(o = m.next()).done; S++)
                h(n, S, O ? f(m, x, [o.value, S], !0) : o.value);
            return (n.length = S), n;
          }
        }
      );
