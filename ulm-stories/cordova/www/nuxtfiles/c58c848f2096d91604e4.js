(window.webpackJsonp = window.webpackJsonp || []).push([
  [2],
  {
    327(t, e, r) {
      ...
      (0, r(12).default)("7d347ec0", content, !0, { sourceMap: !1 });
    },
    328(t, e, r) {
      let content = r(338);
      typeof content === "string" && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, r(12).default)("4a32d774", content, !0, { sourceMap: !1 });
    },
    329(t, e, r) {
      "use strict";
      r(124);
    ...
    332(t, e, r) {
      (e = r(11)(!1)).push([
        t.i,
        ".leaflet-map-container[data-v-31f47408]{overflow-x:auto}",
        ""
      ]),
        (t.exports = e);
    },
    ...
    338(t, e, r) {
      (e = r(11)(!1)).push([
        t.i,
        ".container[data-v-74a9d5ba],body[data-v-74a9d5ba]{margin:0;padding:0}.container[data-v-74a9d5ba]{width:100%}",
        ""
      ]),
        (t.exports = e);
    },
    341(t, e, r) {
      ...
      const n = {
        props: {
          latitude: { type: [String, Number], required: !0 },
          longitude: { type: [String, Number], required: !0 },
          popUpData: { type: String, default: null, required: !1 },
          popUpIsJson: { type: Boolean, default: !1, required: !1 }
        },
        data() {
          return {
            map: null,
        ...
        computed: {
          mapHeight() {
            return this.resizeMap(), this.$vuetify.breakpoint.height - 150;
          },
          mapId() {
            return "map-card-".concat(this._uid);
          }
        },
        mounted() {
          this.buildMap();
          ...
          buildMap() {
            ...
            (this.map = this.$L
              ...
              this.$L
                ...
                .addTo(this.map);
            const marker = this.$L.marker([t, e], {
              title: "lat: ".concat(t, " | lon: ").concat(e),
              riseOnHover: !0
            });
            if (this.popUpData !== null) {
              let r;
              if (this.popUpIsJson) {
                const n = JSON.parse(this.popUpData);
                r = "<h3>Host Information:</h3><v-card><pre id='json-pre'>".concat(
                  JSON.stringify(n, void 0, 2),
                  "</pre></v-card>"
                );
              } else r = this.popUpData;
              marker
                .bindPopup(r, {
                  maxWidth: 200,
                  maxHeight: 200,
      ...
      const l = r(64);
      const c = r.n(l);
      const d = (r(13), r(9), r(6), r(5), r(10), r(3));
      const h = (r(333), r(154));
      const v = r(0);
      const f = (r(83), r(335), r(166));
      const m = r(21);
      const _ = r(102);
      const y = r(157);
      const x = r(26);
      ...
      const j = Object(k.a)(
        m.a,
        Object(_.b)(["absolute", "fixed", "top", "bottom"]),
        y.a,
        x.a
      ).extend({
        ...
        computed: {
          ...
          __cachedDeterminate() {
            return this.$createElement(
              ...
              this.setBackgroundColor(this.color, {
                ...
                style: { width: Object(w.f)(this.normalizedValue, "%") }
              })
            );
          },
            ...
            return this.stream
              ? this.$createElement(
                  ...
                  this.setTextColor(this.color, {
                    ...
                    style: {
                      width: Object(w.f)(100 - this.normalizedBuffer, "%")
                    }
                  })
                )
              : null;
          ...
          backgroundStyle() {
            ...
            return (
              ...
              Object(d.a)(
                ...
                Object(w.f)(this.normalizedValue, "%")
              ),
              Object(d.a)(
                t,
                "width",
                Object(w.f)(this.normalizedBuffer - this.normalizedValue, "%")
              ),
              t
            );
          },
          ...
          computedTransition() {
            return this.indeterminate ? f.b : f.c;
          },
          normalizedBuffer() {
          ...
          styles() {
            ...
            return (
              ...
              this.indeterminate ||
                ...
                (t.width = Object(w.f)(this.normalizedBuffer, "%")),
              t
            );
          }
        },
        methods: {
          genContent() {
            const slot = Object(w.j)(this, "default", {
          ...
          return t(
            "div",
            {
              ...
              style: {
                ...
                height: this.active ? Object(w.f)(this.height) : 0,
      ...
      const P = Object(k.a)(B, z.a, h.a).extend({
        name: "v-card",
        props: {
          flat: Boolean,
          hover: Boolean,
        ...
        computed: {
          ...
          styles() {
            const style = S({}, h.a.options.computed.styles.call(this));
            return (
              this.img &&
        ...
        methods: {
          genProgress() {
            const t = B.options.methods.genProgress.call(this);
            return t
              ? this.$createElement(
                  "div",
            ...
            [
              e(
                ...
                [
                  e(
                    "v-flex",
                    { attrs: { xs10: "", sm10: "", md10: "", lg10: "" } },
                    [
                      e("v-card", { staticClass: "leaflet-map-container" }, [
                        e("div", {
                          style: { height: this.mapHeight + "px", zIndex: 0 },
                          attrs: { id: this.mapId }
                        })
                      ])
                    ],
      ...
      const V = component.exports;
      c()(component, { VCard: P, VFlex: $.a, VLayout: E.a });
      const L = {
        name: "Map",
        components: { LeafletMap: V },
        data() {
          return {};
        }
      };
        ...
        Object(o.a)(
          ...
          function() {
            ...
            return e(
              ...
              [
                e("leaflet-map", {
                  attrs: { latitude: "29.7545", longitude: "-95.4093" }
                }),
                this._v(" "),
                e("div", {}, [e("NuxtChild")], 1)
              ],
