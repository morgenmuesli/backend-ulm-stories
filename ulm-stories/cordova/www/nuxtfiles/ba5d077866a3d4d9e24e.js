  ...
  [3],
  {
    ...
    226(e, t, c) {
      ...
      const n = {
        ...
        methods: {
          getBackgroundUrl() {
            const e = this.dialogs[this.chapter_id].background;
            return (
              window.console.log(e), { "background-image": 'url("' + e + '")' }
            );
          },
          getImagePath() {
            const img = this.dialogs[this.chapter_id].imagePath;
